...
// Image to show when "No" is clicked
const SAD_GIF_URL = "https://media.giphy.com/media/ISOckXUybVfQ4/giphy.gif"; // Sad cat gif
...
function handleNoClick() {
    ...
    // Change image to sad pout
    mainImage.src = SAD_GIF_URL;
